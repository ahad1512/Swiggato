...
public class OrderService {
    ...
    public OrderService(ValidationUtils validationUtils, OrderRepository orderRepository, CustomerRepository customerRepository, DeliveryPartnerRepository deliveryPartnerRepository, RestaurantRepository restaurantRepository) {
